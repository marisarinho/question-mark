...
public class CorridaParticipanteController {
    ...
    public String iniciar(@PathVariable Long id, HttpSession session, Principal principal, RedirectAttributes redirect) {
        ...
        redirect.addFlashAttribute("mensagem", "Corrida comecou!!");
    ...
    public String exibirPergunta(
        ...
        if (pergunta == null) {
            return finalizarCorrida(session, principal, "Corrida concluida!", redirectAttributes);
        }
    ...
    public String processarResposta(
        ...
        if (perguntaAtual == null) {
            return finalizarCorrida(session, principal, "Voce terminou a corrida!", redirect);
        }
